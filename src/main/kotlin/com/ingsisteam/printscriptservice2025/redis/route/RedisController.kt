package com.ingsisteam.printscriptservice2025.redis.route
...
constructor(
    ...
    private fun getBooleanValue(rules: List<com.ingsisteam.printscriptservice2025.redis.dto.Rule>, name: String, default: Boolean): Boolean {
        val value: Any? = rules.find { it.name == name }?.value
        return if (value is Boolean) value else default
    }

    private fun getIntValue(rules: List<com.ingsisteam.printscriptservice2025.redis.dto.Rule>, name: String, default: Int): Int {
        val value: Any? = rules.find { it.name == name }?.value
        return if (value is Number) value.toInt() else default
    }

    private fun getStringValue(rules: List<com.ingsisteam.printscriptservice2025.redis.dto.Rule>, name: String, default: String): String {
        val value: Any? = rules.find { it.name == name }?.value
