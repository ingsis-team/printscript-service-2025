package com.ingsisteam.printscriptservice2025.controller
...
import com.ingsisteam.printscriptservice2025.model.dto.SnippetOutputDTO
...
class SnippetController(
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
                description = "Snippet ejecutado exitosamente",
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
                description = "Snippet formateado exitosamente",
                content = [Content(mediaType = "application/json", schema = Schema(implementation = SnippetOutputDTO::class))],
            ),
            ApiResponse(responseCode = "400", description = "Datos del snippet inválidos"),
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
                description = "Análisis completado, retorna lista de problemas encontrados",
